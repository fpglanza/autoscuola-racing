export const patentiData = {
  hero: {
    heading: "Ogni traguardo ha la sua guida.",
    intro:
      "Dall'indipendenza dei 14 anni alla carriera nel trasporto merci e persone: orientarsi tra normative, limiti di età e tonnellaggi non è semplice. In questa sezione trovi tutto quello che devi sapere per scegliere il percorso giusto, con la garanzia del supporto Racing in ogni fase.",
  },
  ...
  items: [
...

    {
      ...
      content: [
        ...
        "A1 (16 anni): Moto fino a 125cc e 11kW.",
...

    {
      ...
      content: [
        ...
        "Formazione iniziale e rinnovo periodico.",
      ],
      cta: {
